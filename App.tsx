...
const App: React.FC = () => {
  ...
  const renderEconomic = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <div className="bg-slate-900/40 p-4 sm:p-5 rounded-xl border border-slate-800 h-[22rem] sm:h-80">
  ...
  const renderSocial = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-slate-900/40 p-4 sm:p-6 rounded-xl border border-slate-800 lg:col-span-2 h-[22rem] sm:h-80">
        ...
        <div className="bg-slate-900/40 p-4 sm:p-5 rounded-xl border border-slate-800 h-[22rem] sm:h-80">
          ...
          <ResponsiveContainer width="100%" height="88%">
            <BarChart data={SOCIAL_COMPANIONSHIP_DATA} layout="vertical" margin={{ left: 20 }}>
              ...
              <YAxis type="category" dataKey="group" stroke="#475569" fontSize={10} axisLine={false} tickLine={false} width={130} />
              <Tooltip cursor={false} formatter={(v: number) => [`${v}%`, 'Share']} contentStyle={{ backgroundColor: '#0f172a', border: 'none', borderRadius: '8px' }} />
        ...
        <div className="bg-slate-900/40 p-4 sm:p-5 rounded-xl border border-slate-800 h-[22rem] sm:h-80">
          ...
          <ResponsiveContainer width="100%" height="88%">
            <BarChart data={POLITICAL_POLL_DATA} layout="vertical" margin={{ left: 20 }}>
              <CartesianGrid strokeDasharray="3 3" stroke="#1e293b" horizontal={false} />
              <XAxis type="number" stroke="#475569" fontSize={10} axisLine={false} tickLine={false} />
              <YAxis type="category" dataKey="name" stroke="#475569" fontSize={10} axisLine={false} tickLine={false} width={130} />
      ...
      <div className="bg-slate-900/40 p-5 rounded-xl border border-slate-800 h-[420px]">
        ...
        <ResponsiveContainer width="100%" height="88%">
          <BarChart data={CAPABILITY_DOMAIN_SCORES} layout="vertical" margin={{ left: 20 }}>
            ...
            <YAxis type="category" dataKey="domain" stroke="#475569" fontSize={10} axisLine={false} tickLine={false} width={120} />
            <Tooltip cursor={false} contentStyle={{ backgroundColor: '#0f172a', border: 'none', borderRadius: '8px' }} />
  ...
  const navItemClass = (cat: Category) => `
    flex items-center justify-center gap-2 px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium transition-all whitespace-nowrap
    ${activeCategory === cat 
  ...
  return (
    <div className="h-screen w-full bg-slate-950 flex flex-col font-sans overflow-hidden">
      {/* Top Navigation */}
      <nav className="w-full border-b border-slate-800 bg-slate-950/80 backdrop-blur-md sticky top-0 z-40 px-3 py-3 sm:px-5 lg:px-8 flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 shrink-0">
        <button 
          onClick={() => setActiveCategory('Overview')} 
          className={`${navItemClass('Overview')} self-start`}
        >
        ...
        <div className="w-full sm:w-auto sm:ml-auto flex items-center justify-end gap-2 overflow-x-auto scrollbar-hide pb-1 sm:pb-0">
        ...
        <div className="animate-in fade-in slide-in-from-bottom-2 duration-700">
          {activeCategory === 'Overview' && (
            <div className="space-y-12">
              <section className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 sm:p-6 lg:p-8 w-full space-y-4">
                <div className="text-[10px] uppercase font-black tracking-[0.2em] text-slate-400">
                  Free AI Transparency Dashboard
                </div>
                <h2 className="text-xl sm:text-2xl lg:text-4xl font-bold text-white tracking-tight leading-tight">
              ...
              <section className="p-4 sm:p-5 bg-slate-900/40 border border-slate-800 rounded-xl w-full">
              ...
              <section>
                ...
                <div className="bg-slate-900/40 p-4 sm:p-5 rounded-xl border border-slate-800 h-[22rem] sm:h-[360px] mb-6">
